...
groq_client = Groq(api_key="")  # Replace with your actual Groq key
vector_db = None
system_persona = None

def crawl_website(start_url, max_links=10):
    visited = set()
    to_visit = [start_url]
...
def upload_url():
    ...
    try:
        ...
        return jsonify({
            'message': 'Website crawled and processed successfully',
            'url': url,
            'pages_loaded': len(all_urls),
